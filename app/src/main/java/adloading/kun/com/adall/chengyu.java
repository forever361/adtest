...
public class chengyu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_chengyu);
        initView();
    }
    ...
    class CheckBoxListener implements CompoundButton.OnCheckedChangeListener {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(chengyu.this, String.valueOf(TIME), Toast.LENGTH_SHORT).show();
